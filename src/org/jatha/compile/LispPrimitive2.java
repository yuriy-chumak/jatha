 ...
 */
public abstract class LispPrimitive2 extends LispPrimitive
{
/* ------------------ CONSTRUCTORS    ------------------------------ */
	/**
			...
			throws CompilerException
	{
	    ...
	    LispValue result = this.Execute(arg1, arg2);
  ...
  public String parameterCountString()
  {
	...
	protected abstract LispValue Execute(LispValue arg1, LispValue arg2)
			throws CompilerException;
}